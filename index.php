            ...
            <form method="post" action="#">
                ...
                <div class="form-group row input ml-1 mr-1">
                    ...
                    <select name="drop" id="drop" class="col-sm-9 col-md-9 col-xs-9 col-lg-9 input sel form-control-plaintext">
                        <option value="10">Enter Drop for ride location</option>
                ...
                <div class="form-group row input ml-1 mr-1">
                    ...
                    <select name="cars" class="col-sm-9 col-md-9 col-xs-9 col-lg-9 input sel form-control-plaintext" id="cars">
                        <option value="20">Down to select Cab type</option>
                ...
                <div class="form-group row ml-1 mr-1">
                    <input type="button" value="Calculate Fare" class="button2 col-sm-12 col-md-12 col-xs-12 col-lg-12 py-2 mb-3  form-control-plaintext" id="submit">
                    <input type="submit" value="Book Ride"  class="button2 col-sm-12 col-md-12 col-xs-12 col-lg-12 py-2 mb-3 form-control-plaintext" id="book">
                    </div>
